...
\begin{frame}[fragile]
  ...
  \end{block}
\begin{lstlisting} 
table3<-read.xlsx2("3_Follow up data from contaminated site_MK.xlsx", sheetName ="Sheet1",header=TRUE,rowNames=FALSE,colClasses=c(rep("character",3),
...
\begin{frame}[fragile]
  ...
  \item Generally we would use NA but in this case 0 is better as its likely the rows were missing as non were detected
 \end{itemize}
