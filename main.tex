...
\begin{frame}[fragile]
  ...
  \item The variable names are long so lets flit it with $coord\_flip()$
...
\begin{frame}[fragile]
  ...
  \item lets fix the one with phosphate as the 9 is typed twice
