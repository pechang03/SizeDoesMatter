...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.Date.default(table2f\$Sample.collection.date, "{}\%d.\%m.\%y"{}): do not know how to convert 'table2f\$Sample.collection.date' to class "{}Date"{}}}\begin{verbatim}
##                  Group                   Site                    Rep 
##              "numeric"              "numeric"              "numeric" 
##             Spill.date Sample.collection.date                 labnum 
##              "numeric"              "numeric"              "numeric" 
##        phosphate..ppb.          ammonia..ppb.     chlorophyll..ug.L. 
##              "numeric"              "numeric"              "numeric" 
##                 DO....          phormidiaceae       streptococcaceae 
##              "numeric"              "numeric"              "numeric" 
##           vibrionaceae     enterobacteriaceae    verrucomicrobiaceae 
##              "numeric"              "numeric"              "numeric" 
##        chloroflexaceae         aeromonadaceae      staphylococcaceae 
##              "numeric"              "numeric"              "numeric" 
##         clostridiaceae     oceanospirillaceae       synechococcaceae 
##              "numeric"              "numeric"              "numeric" 
##      rhodospirillaceae               rowNames 
##              "numeric"              "logical"
##                  Group                   Site                    Rep 
...
\begin{frame}[fragile]
  ...
  \end{itemize}
  3%_Follow up data from contaminated site.xlsx
  \end{block}
\begin{lstlisting} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}rename"{}}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(X = X, FUN = FUN, ...): object 'table3fiii' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(X = X, FUN = FUN, ...): object 'table3fiii' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rbind(m3ii, table3fiii): object 'm3ii' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(X = X, FUN = FUN, ...): object 'table4' not found}}\end{kframe}
\end{knitrout}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{dropping variables}
